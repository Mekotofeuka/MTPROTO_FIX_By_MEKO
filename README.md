...
Данный скрипт используется для серверов с MTPROTO пррокси, фиксит проблему долгого первичного TCP-подключения клиентов либо его полное отсутствие(не подключается к прокси), **имеет ряд преимуществ**:
