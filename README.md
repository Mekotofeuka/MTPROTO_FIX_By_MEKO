...
**Полноценный комбайн-менеджер для работы с прокси**:
 ...
 **Проверен на: Telemt 3.4.24, MTProto.zig 1.9.0, Mtg 2.2.8, MTProtoProxy, JSMTProxy**

Данный скрипт используется для серверов с MTPROTO - (telemt,mtproto zig и тд.), фиксит проблему долгого первичного TCP-подключения клиентов либо его полное отсутствие(не подключается к прокси), **имеет ряд преимуществ**:
