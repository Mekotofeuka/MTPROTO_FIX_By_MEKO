...
<p align="center">
  · <a href="#Быстрый-старт">Установка в 1 клик</a> · <a href="#Как-работает-фикс">Как работает то?</a> · <a href="#Возможные-проблемыпочему-у-меня-может-не-работать">Решение проблем</a> · <a href="https://github.com/Mekotofeuka/MTPROTO_FIX_By_MEKO/blob/main/README_eng.md">English</a> ·
</p>
...
**Позволяет удобно в пару кликов** работать с **TELEMT, MTG и MTPROTO.ZIG**, поддерживая большинство необходимых команд для взаимодействия:
Установка, обновление, откат, настройка, изменение конфигов, просмотр логов, получение ссылки на подключение без ввода каких-либо команд.

⭐️Один из наших фиксов старой версии уже взяли себе в использование TELEMT и Mtproto zig⭐️
...
```
2. **Установить стандартный Telemt**, также **альтернативой** вы можете поставить "**MTPROTO.zig**" или **MTG**
